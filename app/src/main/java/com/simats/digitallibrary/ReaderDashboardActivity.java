...
public class ReaderDashboardActivity extends AppCompatActivity {
    ...
    private void buildCategoryCards(JSONObject categories, int totalBooks) {
        ...
        // Show ALL categories from database - whatever admin adds will show here
    ...
    private void buildSampleCategories() {
        // No hardcoded categories - only show what exists in database
        layoutCategories.removeAllViews();
        // Show a message or just leave empty - categories will load when API works
    }
