...
public class WishlistAdapter extends RecyclerView.Adapter<WishlistAdapter.WishlistViewHolder> {
    ...
    class WishlistViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(Book book) {
            ...
            // Load cover image - with fallback logic
            loadBookCover(book, ivBookCover);
        ...
        /**
         * Load book cover with fallback logic:
         * 1. Database cover_url if valid
         * 2. Open Library using title
         * 3. Placeholder
         */
        private void loadBookCover(Book book, ImageView imageView) {
            ...
            if (coverUrl != null && !coverUrl.isEmpty() && !coverUrl.equals("0")) {
                ...
                if (!coverUrl.startsWith("http")) {
                    coverUrl = ApiConfig.BASE_URL + coverUrl;
                }
            ...
            // Priority 2: Use Open Library search by title
            else if (book.getTitle() != null && !book.getTitle().isEmpty()) {
                String searchQuery = book.getTitle().replace(" ", "+");
                String openLibraryUrl = "https://covers.openlibrary.org/b/title/" + searchQuery + "-M.jpg";
            ...
            // Priority 3: Use placeholder
                ...
                imageView.setImageResource(R.drawable.ic_library_book);
            }
        }
    }
}
